...
| SEO, LLMO & Agent-Readiness | [seo-llmo-guide.md](./seo-llmo-guide.md) | SEO, LLMO (Large Language Model Optimization), and agent-readiness for public sites  -  meta tags, Open Graph, JSON-LD, llms.txt, robots.txt with Content-Signal, sitemaps, Markdown content negotiation, Link headers, and the Agent Skills index. Scored by [isitagentready.com](https://isitagentready.com/). |
